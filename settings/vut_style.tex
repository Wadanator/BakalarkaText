...
\usepackage{array} % advanced table column formatting
...
\usepackage{float} % allows absolute [H] figure placement
\usepackage[section]{placeins} % keeps floats inside their sections
...
% coloring format
\usepackage[pdftitle={\thethesistitle},
pdfauthor={\theauthor},
%pdftex=true,
