...
Dôležitým aspektom pri návrhu expozície je aj dispozičné riešenie fyzického priestoru. V~lineárnych priestoroch, ako sú chodby, sa uplatňuje skôr sekvenčné radenie interakcií, zatiaľ čo otvorené priestory si vyžadujú epizodické členenie s~voľnejším prechodom medzi uzlami \cite{interactive_exhibition_narrations}. Tieto priestorové požiadavky priamo ovplyvňujú návrh riadiaceho systému: ten musí zvládnuť nielen lineárne prehrávanie obsahu, ale aj vetvenie scenára na základe aktuálnej interakcie návštevníka \cite{computational_frameworks_art}.
