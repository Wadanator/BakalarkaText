...
SEM EDITNUT TEXT, PRIDAM OBRAZOK KTORY UKAZE AKO JE ZAPOJENE RPI.... SCHEMA LEN + MOZNO AKO TO MAM IRL
Na napájanie Raspberry Pi je využívaný USB-C adaptér - 5,0\,V / 3,0\,A.

\vspace{1cm}
\begin{center}
    \textit{[MIESTO PRE OBRÁZOK: Fotografia zapojeného Raspberry Pi
    s~HDMI a~LAN káblom, umiestneného za LCD displejom]}
\end{center}
\vspace{1cm}
