...
\textbf{CHRONOS}). Pohon je navrhnutý pre ovládanie hlavných hodinových
mechanizmov a~ozubených kolies inštalácie, ktorých
konštrukcia je popísaná v~kapitole~\ref{MechanickaKonstrukcia}.
