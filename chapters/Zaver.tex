...
Počas skúšobného obdobia sa neprejavil stav vyžadujúci neplánovaný
manuálny reštart a~po výpadku napájania sa systém obnovil do plne
funkčného stavu približne za 38 sekúnd.

Na hardvérovej úrovni sa rozhodnutie stavať na hotových
komerčne dostupných moduloch namiesto vlastných dosiek osvedčilo.
...
Najväčší priestor na ďalší rozvoj predstavuje rozšírenie stavového automatu
...
(PoE) a~zbernicu RS-485. V~budúcich nasadeniach, kde nie je
...
v~tejto práci. Zbernica RS-485 by zas otvorila možnosť
